...
public class PolicialPenalView extends javax.swing.JInternalFrame {
    ...
    private void preencherTabela() {
        ...
        if (lista.isEmpty()) {
            JOptionPane.showMessageDialog(this, "NENHUM POLICIAL PENAL CADASTRADO! (PolicialPenalView ln 41)",
    ...
    private void btn_salvarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_salvarActionPerformed
        ...
        if (cpf.isEmpty() || nome.isEmpty() || entrada.isEmpty() || saida.isEmpty()) {
            ...
            if (controller.inserir(policial)) {
                JOptionPane.showMessageDialog(this, "POLICIAL CADASTRADO!", "Salvamento realizado...",
                        JOptionPane.INFORMATION_MESSAGE);
                limparCampos();
                inicializar();
                preencherTabela();
                ...
                JOptionPane.showMessageDialog(this, "ERRO AO INSERIR POLICIAL", "Algo de errado não está certo....",
    ...
    private void acaoGerarRelatorio() throws IOException {
        ...
        Relatorios.relatorio("teste_policial", "", "");
    ...
    private void tb_policialMouseClicked(java.awt.event.MouseEvent evt) {
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_editarActionPerformed
        ...
        String nome = cxt_nome.getText();
        String cpf = cxt_cpf.getText();
        String turno_entrada = cxt_entrada.getText();
        String turno_saida = cxt_saida.getText();

        if (nome.isEmpty() || cpf.isEmpty() || turno_entrada.isEmpty() || turno_saida.isEmpty()) {
            ...
            PolicialPenalModel policial = new PolicialPenalModel();
            policial.setIdpolicialpenal(id);
            policial.setCpf(cpf);
            policial.setNome(nome);
            policial.setTurno_entrada(turno_entrada);
            policial.setTurno_saida(turno_saida);

            // ---------------- CONTROLLER
            PolicialPenalController controller = new PolicialPenalController();
            if (controller.editar(policial)) {
                ...
                JOptionPane.showMessageDialog(this, "ERRO AO EDITAR POLICIALPENAL", "Algo de errado não está certo....",
                        JOptionPane.ERROR_MESSAGE);
